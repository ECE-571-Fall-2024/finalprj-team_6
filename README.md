run.do file is in the SIM folder. Must be in the the SIM folder to run. Paths were made relative. run.do file will load and run waveform and print transcript.
